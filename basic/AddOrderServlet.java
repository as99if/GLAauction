 ...
 * @author User
 */
@WebServlet(name = "AddOrderServlet", urlPatterns = {"/addOrders"})
public class AddOrderServlet extends HttpServlet {
    
    Bidder bidder;

    @EJB
    BidderManager userManager;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            orderManager.addOrder(item, bidder);
            itemManager.changeStatus(item, Item.SALE_CLOSED);
        } catch (Exception exc) {
