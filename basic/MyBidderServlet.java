 ...
 * @author User
 */
@WebServlet(name = "MyBidderServlet", urlPatterns = {"/myBidItems"})
public class MyBidderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (bidder != null) {
            List<Item> items = itemManager.findItemsByBidder(bidder.getId());
