...
public class ItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Long itemId = Long.parseLong(request.getParameter("itemId")); // id auto generated
        String itemName = request.getParameter("itemName");
        String itemDescription = request.getParameter("itemDescription");
        Double itemStartingPrice = Double.parseDouble(request.getParameter("itemStartingPrice"));
        ...
        */
        ...
        Item item = new Item(itemName, itemDescription, itemStartingPrice, itemEndDate);
